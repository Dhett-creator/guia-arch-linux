...
Nesta seção serão apresentados alguns passos essenciais após uma instalação nova do Arch Linux, bem como recomendações de ajustes que podem otimizar ainda mais a experiência de uso do sistema.
